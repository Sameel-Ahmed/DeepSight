...
# ─── STEP 4: ENHANCEMENT ───────────────────────────────────────────────────────────
    ...
    for i, key in enumerate(STAGE_KEYS):
        meta = STAGE_META[key]
        with cols_cb[i % 2]:
            # Histogram stretching OFF by default; all others ON
...
# ─── STEP 7: LIVE DEMO ────────────────────────────────────────────────────────
    ...
    with tab_det:
        ...
        # Enhance image using active stages from the Enhancement tab
        try:
        ...
        try:
            ...
            res_yolo   = yolo_model(det_enhanced, verbose=False)
